...
# -NN_MODEL, string, SUMMARY_DIR+'/nn_model_best_constrained.ckpt'
...
state_scale = float(sys.argv[6]) # 100 in 5G, 1 in 3G original pensieve paper.
use_gumbel_noise = int(sys.argv[7]) #1
rm_rtt = int(sys.argv[8])
future_steps = 4
